...
import { mysqlTable, int, double,varchar, date, primaryKey, index, foreignKey} from 'drizzle-orm/mysql-core';
...
export const flyer_store = mysqlTable("flyer_store", {
	...
	flyer_store_flyer_id_store_id: primaryKey({
	  columns: [table.flyer_id, table.store_id],
	  name: "flyer_store_flyer_id_store_id",
	}),
  }));
